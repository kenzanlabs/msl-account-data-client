...
public interface QueryAccessor {
  ...
  public void addUser(@Param("username") String username,
      @Param("creation_timestamp") Date creation_timestamp, @Param("password") String password,
  ...
  public ResultSet albumsByUser(@Param("user_id") UUID user_id,
      @Param("favorites_timestamp") Date favorites_timestamp, @Param("album_id") UUID album_id);
  ...
  @Query("INSERT INTO albums_by_user " + "(user_id, content_type, favorites_timestamp, "
      + "album_id, album_name, album_year, " + "artist_id, artist_mbid, artist_name, image_link ) "
      + "VALUES " + "(:user_id,:content_type,:favorites_timestamp,"
      + ":album_id, :album_name, :album_year,"
      + ":artist_id, :artist_mbid, :artist_name, :image_link)")
  public void addLibraryAlbum(@Param("user_id") UUID user_id,
      @Param("content_type") String content_type,
      @Param("favorites_timestamp") Date favorites_timestamp, @Param("album_id") UUID album_id,
      @Param("album_name") String album_name, @Param("album_year") Integer album_year,
  ...
  @Query("INSERT INTO songs_by_user " + "(user_id,content_type,favorites_timestamp, "
      ...
      + ":song_id, :song_duration, :song_name, :image_link)")
  public void addLibrarySong(@Param("user_id") UUID user_id,
      @Param("content_type") String content_type,
      @Param("favorites_timestamp") Date favorites_timestamp, @Param("song_id") UUID song_id,
  ...
  public ResultSet artistsByUser(@Param("user_id") UUID user_id,
      @Param("favorites_timestamp") Date favorites_timestamp, @Param("artist_id") UUID artist_id);
  ...
  @Query("INSERT INTO artists_by_user " + "(user_id, content_type, favorites_timestamp, "
      ...
      + "(:user_id,:content_type,:favorites_timestamp,"
      + ":artist_id, :artist_mbid, :artist_name, :image_link)")
  public void addLibraryArtist(@Param("user_id") UUID user_id,
      @Param("content_type") String content_type,
      @Param("favorites_timestamp") Date favorites_timestamp, @Param("artist_id") UUID artist_id,
      @Param("artist_mbid") UUID artist_mbid, @Param("artist_name") String artist_name,
      @Param("image_link") String image_link);
