...
public class UserQueryTest {
    ...
    public void init () {
        ...
        when(queryAccessor.getUser(tc.USERNAME))
    ...
    public void testAddUser () {
        ...
        verify(queryAccessor, atLeastOnce()).addUser(
                eq(tc.USER_DAO.getUsername()),
                eq(tc.USER_DAO.getCreationTimestamp()),
                eq(tc.USER_DAO.getPassword()),
                eq(tc.USER_DAO.getUserId())
        );
    }
